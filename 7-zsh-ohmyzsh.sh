...
if test -f "/home/$USER/.zshrc.bak"; then
    ...
    while :; do
        ...
        s | S | "")
            ...
            echo -e "$AZUL Começando em 2... $FIM" && sleep 1
            echo -e "$AZUL Começando em 1... $FIM" && sleep 1
            sudo pacman -Syu gawk thefuck git git-zsh-completion nano zoxide cabextract mise cpio 7zip unace unzip unrar fzf ripgrep ripgrep-all wl-clipboard man-db man-pages man-pages-pt_br --needed --noconfirm
