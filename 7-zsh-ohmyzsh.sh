...
if test -f "/home/$USER/.p10k.zsh"; then
    ...
    while :; do
        ...
        s | S | "")
            ...
            echo -e "$AZUL Começando em 2... $FIM" && sleep 1
            echo -e "$AZUL Começando em 1... $FIM" && sleep 1
            sudo pacman -Syu gawk thefuck git nano xsel zoxide cabextract cpio p7zip unace unzip unrar fzf ripgrep ripgrep-all wl-clipboard man-db man-pages man-pages-pt_br --needed --noconfirm
