...
arquivos EXT4, ZRAM (algoritmo lz4), kernel stable, zen kernel e kernel lts,
idioma pt-BR, pipewire, wireplumber, bluetooth habilitado, repositório multilib
habilitado, Nvidia GPU com o driver Nvidia open kernel module (versão dkms),
shell Zsh com grml-zsh-config e oh-my-posh, Foot terminal, AUR helper Yay,
Flatpak, Podman, Distrobox, Apparmor, firewalld, systemd-resolved,
NetworkManager (default backend), wireless-regdb (WIRELESS_REGDOM="BR"), qemu,
Incus, mise, intel_pstate scaling driver, thermald, intel-lpmd, tuned e
tuned-ppd para gerenciamento de frequências da CPU e do perfil de energia,
