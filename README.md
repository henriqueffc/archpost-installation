...
systemd-resolved, NetworkManager (default backend), wireless-regdb
(WIRELESS_REGDOM="BR"), qemu, Incus, mise, intel_pstate scaling driver,
thermald, intel-lpmd, tuned e tuned-ppd para gerenciamento de frequências da CPU
e do perfil de energia, ananicy-cpp, firmware para o áudio da Sound Open
