...
wget -O firefox-nightly.tar.xz -c "https://download.mozilla.org/?product=firefox-nightly-latest-ssl&os=linux64&lang=pt-BR"

tar -vxf firefox-nightly.tar.xz
