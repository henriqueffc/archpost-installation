...
# Dock
gsettings set org.gnome.shell favorite-apps "['foot.desktop', 'obsidian.desktop', 'firefox.desktop', 'org.telegram.desktop.desktop', 'org.gnome.Fractal.desktop', 'io.gitlab.news_flash.NewsFlash.desktop', 'org.gnome.Podcasts.desktop', 'zotero.desktop', 'org.gnome.Nautilus.desktop']"
