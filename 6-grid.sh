...
# Dock
gsettings set org.gnome.shell favorite-apps "['app.devsuite.Ptyxis.desktop', 'org.mozilla.Thunderbird.desktop', 'firefox.desktop', 'obsidian.desktop', 'org.telegram.desktop.desktop', 'org.gnome.Fractal.desktop', 'com.discordapp.Discord.desktop', 'io.gitlab.news_flash.NewsFlash.desktop', 'dev.geopjr.Tuba.desktop', 'org.gnome.Podcasts.desktop', 'de.haeckerfelix.Shortwave.desktop', 'org.gnome.Nautilus.desktop']"
