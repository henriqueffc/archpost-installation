...
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Programas/ apps "['org.gnome.World.PikaBackup.desktop', 'de.haeckerfelix.Fragments.desktop', 'app.drey.Warp.desktop', 'it.mijorus.gearlever.desktop', 'org.gnome.Firmware.desktop', 'firewall-config.desktop', 'veracrypt.desktop', 'com.github.finefindus.eyedropper.desktop', 'com.github.ADBeveridge.Raider.desktop', 'gparted.desktop', 'org.gtkhash.gtkhash.desktop', 'io.github.flattool.Warehouse.desktop', 'com.github.tchx84.Flatseal.desktop', 'com.mattjakeman.ExtensionManager.desktop', 'gnome-appfolders-manager.desktop', 'alacarte.desktop', 'io.github.fabrialberio.pinapp.desktop', 'scrcpy.desktop', 'scrcpy-console.desktop', 'it.cuteworks.pacmanlogviewer.desktop', 'kvantummanager.desktop', 'qt5ct.desktop', 'qt6ct.desktop']"
