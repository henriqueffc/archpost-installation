...
# Dock
gsettings set org.gnome.shell favorite-apps "['footclient.desktop', 'obsidian.desktop', 'firefox.desktop', 'io.gitlab.news_flash.NewsFlash.desktop', 'zotero.desktop', 'org.gnome.Nautilus.desktop']"
