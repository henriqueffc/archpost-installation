...
# Dock
gsettings set org.gnome.shell favorite-apps "['rio.desktop', 'org.mozilla.Thunderbird.desktop', 'vivaldi-stable.desktop', 'obsidian.desktop', 'org.telegram.desktop.desktop', 'org.gnome.Fractal.desktop', 'io.gitlab.news_flash.NewsFlash.desktop', 'dev.geopjr.Tuba.desktop', 'org.gnome.Podcasts.desktop', 'de.haeckerfelix.Shortwave.desktop', 'org.gnome.Nautilus.desktop']"
