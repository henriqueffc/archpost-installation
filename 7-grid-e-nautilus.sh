...
gsettings set org.gnome.desktop.app-folders.folder:/org/gnome/desktop/app-folders/folders/Jogos/ apps "['steam.desktop', 'heroic.desktop', 'org.gnome.Games.desktop', 'com.usebottles.bottles.desktop', 'io.github.benjamimgois.goverlay.desktop', 'com.discordapp.Discord.desktop', 'net.lutris.Lutris.desktop', 'net.davidotek.pupgui2.desktop', 'winetricks.desktop']"
