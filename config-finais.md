...
|
[anythingLLM](https://github.com/henriqueffc/archpost-installation/blob/main/config-finais.md#anythingLLM)
|
...
`echo "file:///home/nome_do_usuário/Projetos Projetos" >>~/.config/gtk-3.0/bookmarks`
...
Faça o download da versão Appimage no
[github](https://github.com/Mintplex-Labs/anything-llm/releases) do projeto.

Utilize o app flatpak
[Gear Lever](https://flathub.org/pt-BR/apps/it.mijorus.gearlever) para instalar
o Appimage.

**Ícone do aplicativo na dock**

Caso o ícone esteja aparecendo errado na dock, execute o seguinte.

```
sed -i 's/StartupWMClass=AnythingLLM/StartupWMClass=anythingllm-desktop/g' ~/.local/share/applications/anythingllm.desktop
```

**Update**

Configure o [update](https://gearlever.mijorus.it/docs/github-updates/) da
aplicação pelo Gear Lever

Username/Repo:`Mintplex-Labs/anything-llm`

Release file name:`AnythingLLMDesktop.AppImage`
