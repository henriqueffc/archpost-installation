...
| weechat                               | IRC                                                                                |
| wikiman                               | Offline search engine for manual pages (Arch Wiki)                                 |
...
| chromecast      | habilita as portas no firewall (não é permanente) para conexão com o chromecast                                                                                            |
...
`sgpt --model gemma3:4b "o que você pode fazer?"`
...
_Tecla Print_ Abre as opções de captura de tela do Flameshot

_Ctrl + Alt + p_ Abre o menu do Gnome para gravação de tela, captura de janela e
captura de tela.
