...
| omz                        | atualiza o oh-my-zsh, seus plugins e o powerlevel10k                                                                                                                       |
...
| reflector                  | seleção de mirrors para o pacman                                                                                                                                           |
...
| Descrição                                              | Atalho                     |
| ------------------------------------------------------ | -------------------------- |
| Abrir Coleções                                         | Ctrl + Shift + Y           |
| Abrir Favoritos                                        | Ctrl + Shift + O           |
| Abrir Ferramentas de Desenvolvedor                     | Ctrl + Shift + I           |
| Abrir a home page na guia atual                        | Alt + Home                 |
| Abrir uma nova janela InPrivate                        | Ctrl + Shift + N           |
| Avançar                                                | Alt + Seta para a direita  |
| Entrar ou sair da Leitura Avançada                     | F9                         |
| Feche a janela atual                                   | Ctrl + Shift + W           |
| Mudar para a guia anterior                             | Ctrl + Shift + Tab         |
| Reabrir a última guia fechada e alternar para ela      | Ctrl + Shift + T           |
| Recarregar a guia atual, ignorando o conteúdo em cache | Shift + F5                 |
| Recarregar a página atual                              | F5                         |
| Voltar                                                 | Alt + Seta para a esquerda |
| abrir arquivo do computador no Edge (texto e imagens)  | Ctrl + O                   |
| abrir o histórico                                      | Ctrl + H                   |
| abrir o menu de configurações                          | Alt + F                    |
| abrir uma consulta de pesquisa na barra de endereços   | Ctrl + K                   |
| acessa a barra de endereços                            | Ctrl + l ou somente F4     |
| fecha a aba atual                                      | Ctrl + W                   |
| localizar na página                                    | Ctrl + F ou somente F3     |
| muda para a próxima aba                                | Ctrl + tab                 |
| muda para aba da direita                               | Ctrl + Page Down           |
| muda para aba da esquerda                              | Ctrl + Page Up             |
| nova aba                                               | Ctrl + t                   |
| nova janela                                            | Ctrl + N                   |
| paleta de comandos                                     | Ctrl + Q                   |
| salvar a guia como favorita                            | Ctrl + D                   |
