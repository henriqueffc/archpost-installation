...
alias cpu-performance="sudo cpupower frequency-set --governor performance && sudo x86_energy_perf_policy -a performance --hwp-min 18 --hwp-max 46"
alias cpu-powersave="sudo cpupower frequency-set --governor powersave && sudo x86_energy_perf_policy -a balance-performance --hwp-min 18 --hwp-max 46"
...
alias search="pacman -Slq | fzf --preview 'pacman -Si {}' --preview-window=up,50% --height 70%"
