...
alias neo="fastfetch"
alias atualizar="pipx upgrade-all && flatpak update && flatpak remove --unused && archnews && sudo pacman -Syu && yay --removemake --noanswerclean --noansweredit --noconfirm --needed -Sua --devel"
...
alias chromecast-on="sudo firewall-cmd --zone=public --add-service=mdns"
alias chromecast-off="sudo firewall-cmd --zone=public --remove-service=mdns"
