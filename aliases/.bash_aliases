alias mpv="mpv --vo=gpu --hwdec=auto-safe --autofit-larger=60%x60% --save-position-on-quit"
alias mpv-yt="mpv --vo=gpu --hwdec=vaapi --ytdl-format='((bestvideo[height<=?1080]/bestvideo)+(bestaudio[acodec=opus]/bestaudio))/best' --autofit-larger=60%x60% --save-position-on-quit"
alias mpv-yt-nv="prime-run mpv --vo=gpu --hwdec=cuda --ytdl-format='((bestvideo[height<=?1080]/bestvideo)+(bestaudio[acodec=opus]/bestaudio))/best' --autofit-larger=60%x60% --save-position-on-quit"
...
alias erro="sudo dmesg -l err && systemctl --failed && journalctl -p 3 -xb"
