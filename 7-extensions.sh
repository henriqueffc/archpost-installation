...
aria2c https://github.com/ubuntu/gnome-shell-extension-appindicator/archive/refs/tags/v43.zip
gnome-extensions install --force 'gnome-shell-extension-appindicator-43.zip'
